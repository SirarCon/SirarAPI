...
AtletaSchema.method('todaInformacion', function() {
    return {
      ...
      fechaNacimiento: this.fechaNacimiento ? funcionesGlobales.formatoFecha(this.fechaNacimiento.toString()) : this.fechaNacimiento,
      edad: this.fechaNacimiento ? funcionesGlobales.calcularEdad(this.fechaNacimiento.toString()) : 0,
      ...
      venceVisa: this.venceVisa ? funcionesGlobales.formatoFecha(this.venceVisa.toString()) : this.venceVisa,
      ...
      fechaDebut: this.fechaDebut ? funcionesGlobales.formatoFecha(this.fechaDebut.toString()) : this.fechaDebut,
